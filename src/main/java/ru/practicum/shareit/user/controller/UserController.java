...
public class UserController {
    ...
    public UserResponse addNewUser(@RequestBody @Valid UserCreateRequest userCreateRequest) {
    ...
    @PatchMapping("/{userId}")
    public UserResponse updateUser(@RequestBody @Valid UserUpdateRequest userUpdateRequest, @PathVariable Integer userId) {
